import { BadRequestException, Controller, Get, Header, StreamableFile } from '@nestjs/common';
...
export class AppController 
{
  ...
  discover(): void
  {
    this.discoveryService.discoverArticles();
  }

  @Get('generate')
  generate(): void 
  {
    this.generatorService.generatePdf([TEST_ARTICLE]);
  }
}
